...
@section('content')
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="container"><h2>Мотивации мероприятия: {{$event->name}}</h2></div>
            </div>
            <div class="panel-body">
                <div class="container">
                    ...
                    <div class="items-list">
                        @include('admin_panel.events.motivations.list', ['event' => $event])
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>App.ajax_url = '/adminpanel/events/'+"{{$event->id}}"+'/motivations';</script>
@endsection